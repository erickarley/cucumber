...
export const hooks = {
    ...
    //     // });
    //     // let specExecuted = process.argv[4].substring(process.argv[4].lastIndexOf('\\')+1,process.argv[4].lastIndexOf('.'));
    //     // console.log('Spec to execute: ' + specExecuted);

    //     // global.versionNumber = '';
    //     let reportAggregator = new ReportAggregator({

    //         // outputDir: './reports/html-reports/' + specExecuted + '/',
    //         outputDir: './reports/html-reports/',
    //         // filename: specExecuted + '-report.html',
    //         filename: 'master-report.html',
    //         reportTitle: 'Agilence TAF Report - ',
    ...
    //     var fs = require('fs');
    //     fs.writeFile('./reports/versionNumber.txt', "No-Version", function (err) {
    //     });
    // },
    /**

...
export default async(widgetName, widgetSelected, widgetCategory, widgetDimension, widgetDataElement) => {
     ...
     * @type {String}
     */
    const widgetsComponentOption = "//h3[.='Announcements']";

    /**
     * Selector for the announcement Name
     * @type {String}
     */
    const widgetInput = "//input[@class[contains(.,'" + WidgetName + "')]]";
    ...
    if (elementToFind.length > 0) {
        ...
        let screenshotName = 'Widget-Announcement-' + widgetName + '-NOT-EXISTS'; 

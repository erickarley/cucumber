...
export default async () => {
    try {
        ...
        const psPublicScriptPath = "./src/support/pws_scripts/Updatereportstopublic.ps1";
        const psScriptPath = "./src/support/pws_scripts/sqlReportIdRecentlyRun.ps1";
        ...
        const executePowerShellScripts = (databaseServer) => {
            ...
            // Execute "Updatereportstopublic.ps1"
            ...
            console.log(`Output from Updatereportstopublic.ps1 (Server: ${databaseServer}):`, psPublicOutput);

            // Execute "sqlReportIdRecentlyRun.ps1"
            ...
            console.log(`Output from sqlReportIdRecentlyRun.ps1 (Server: ${databaseServer}):`, psOutput);

            // Parse the IDs from the output of sqlReportIdRecentlyRun.ps1
            ...
            console.log(`Parsed Report IDs for server ${databaseServer}:`, arrayOfStrings);
        ...
        await browser.sharedStore.set('reports', reportsServer1);

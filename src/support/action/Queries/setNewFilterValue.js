...
export default async(category, fieldToSelect, operator, value) => {
     ...
     * @type {String}
     */
    const filterListItemSelector = "//div[@ng-repeat[contains(.,'dcItem in fdCtrl.filteredNouns')]]/span[1][text()='" + fieldToSelect + "']";

    /**
     * Selector for the option of the filters area
     * @type {String}
     */
    const operatorSelector = "//span[.='" + operator +"']";

    /**
     * Selector for the option of the filters area
     * @type {String}
     */
    const valueFieldSelector = "//input[@name='value']";

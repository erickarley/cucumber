...
export default async(category, fieldToSelect, operator, value) => {
     ...
     * @type {String}
     */
    const filterOptionSelector = "//md-option[@data-ng-repeat='dc in fdCtrl.categoryDropdownState.items'][.='";
     ...
     * @type {String}
     */
    const operatorSelector = "//div[@ng-repeat='operator in odc.Operators track by $index']//span[.='" + operator +"']";

Feature: Measure Query Builder Followed By Tests
    As a Developer of the Measure Query Builder
    I want to automate testing of the Measure Query Builder Acceptance Criteria
    so that we can be made aware of the Measure Query Builder feature no longer meets the Acceptance Criteria

    Background:
        Given   I am creating a followed by measure query
